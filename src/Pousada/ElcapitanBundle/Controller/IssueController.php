...
class IssueController extends Controller
{
     ...
     * @Method("POST")
     * @Template("PousadaElcapitanBundle:Issue:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PousadaElcapitanBundle:Issue')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PousadaElcapitanBundle:Issue:edit.html.twig")
     */
