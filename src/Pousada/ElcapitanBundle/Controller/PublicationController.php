...
use Pousada\ElcapitanBundle\Entity\Publication;
use Pousada\ElcapitanBundle\Form\PublicationType;
...
class PublicationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PousadaElcapitanBundle:Publication')->findAll();
     ...
     * @Method("POST")
     * @Template("PousadaElcapitanBundle:Publication:new.html.twig")
     */
    public function createAction(Request $request)
    {
        $entity = new Publication();
        $form = $this->createCreateForm($entity);
        $form->handleRequest($request); //the form receives de requests userinput

        if ($form->isValid()) {
            $em = $this->getDoctrine()->getManager();
            $em->persist($entity);
            $em->flush(); //makes the query and synchronizes with database
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PousadaElcapitanBundle:Publication')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PousadaElcapitanBundle:Publication:edit.html.twig")
     */
