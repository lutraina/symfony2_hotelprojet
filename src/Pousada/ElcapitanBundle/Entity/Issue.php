 ...
 * @ORM\Entity(repositoryClass="Pousada\ElcapitanBundle\Entity\IssueRepository")
 */
class Issue
{
	 ...
	 * @ORM\JoinColumn("publication_id", referencedColumnName="id")
	 */
	private $publication;
     ...
     * Set publication
     *
     * @param \Pousada\ElcapitanBundle\Entity\Publication $publication
     * @return Issue
     */
    public function setPublication(\Pousada\ElcapitanBundle\Entity\Publication $publication = null)
    {
     ...
     * Get publication
     *
     * @return \Pousada\ElcapitanBundle\Entity\Publication 
     */
